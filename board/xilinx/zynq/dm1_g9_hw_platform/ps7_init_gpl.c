...
unsigned long ps7_pll_init_data_3_0[] = {
    EMIT_WRITE(0xf8000008, 0x0000df0d),
    ...
    EMIT_WRITE(0xf8000004, 0x0000767b),
    EMIT_EXIT(),
};

unsigned long ps7_clock_init_data_3_0[] = {
    EMIT_WRITE(0xf8000008, 0x0000df0d),
    EMIT_MASKWRITE(0xf8000128, 0x03f03f01, 0x00700f01),
    ...
    EMIT_MASKWRITE(0xf8000150, 0x00003f33, 0x00000a01),
    EMIT_MASKWRITE(0xf8000154, 0x00003f33, 0x00000a02),
    EMIT_MASKWRITE(0xf8000168, 0x00003f31, 0x00000501),
    EMIT_MASKWRITE(0xf8000170, 0x03f03f30, 0x00400500),
    EMIT_MASKWRITE(0xf8000180, 0x03f03f30, 0x00400500),
...
unsigned long ps7_ddr_init_data_3_0[] = {
    ...
    EMIT_MASKWRITE(0xf8006014, 0x001fffff, 0x0004159a),
    EMIT_MASKWRITE(0xf8006018, 0xf7ffffff, 0x44e458d2),
    EMIT_MASKWRITE(0xf800601c, 0xffffffff, 0x720238e5),
    EMIT_MASKWRITE(0xf8006020, 0x7fdffffc, 0x270872d0),
    EMIT_MASKWRITE(0xf8006024, 0x0fffffc3, 0x00000000),
    EMIT_MASKWRITE(0xf8006028, 0x00003fff, 0x00002007),
    EMIT_MASKWRITE(0xf800602c, 0xffffffff, 0x00000008),
    EMIT_MASKWRITE(0xf8006030, 0xffffffff, 0x00040930),
    ...
    EMIT_MASKWRITE(0xf8006044, 0x0fffffff, 0x0ff66666),
    ...
    EMIT_MASKWRITE(0xf8006068, 0x03ffffff, 0x00284141),
    ...
    EMIT_MASKWRITE(0xf80060b8, 0x01ffffff, 0x00200066),
    ...
    EMIT_MASKWRITE(0xf800612c, 0x000fffff, 0x00029000),
    EMIT_MASKWRITE(0xf8006130, 0x000fffff, 0x00029000),
    EMIT_MASKWRITE(0xf8006134, 0x000fffff, 0x00029000),
    EMIT_MASKWRITE(0xf8006138, 0x000fffff, 0x00029000),
    ...
    EMIT_MASKWRITE(0xf8006154, 0x000fffff, 0x00000080),
    EMIT_MASKWRITE(0xf8006158, 0x000fffff, 0x00000080),
    EMIT_MASKWRITE(0xf800615c, 0x000fffff, 0x00000080),
    EMIT_MASKWRITE(0xf8006160, 0x000fffff, 0x00000080),
    EMIT_MASKWRITE(0xf8006168, 0x001fffff, 0x000000f9),
    EMIT_MASKWRITE(0xf800616c, 0x001fffff, 0x000000f9),
    EMIT_MASKWRITE(0xf8006170, 0x001fffff, 0x000000f9),
    EMIT_MASKWRITE(0xf8006174, 0x001fffff, 0x000000f9),
    EMIT_MASKWRITE(0xf800617c, 0x000fffff, 0x000000c0),
    EMIT_MASKWRITE(0xf8006180, 0x000fffff, 0x000000c0),
    EMIT_MASKWRITE(0xf8006184, 0x000fffff, 0x000000c0),
    EMIT_MASKWRITE(0xf8006188, 0x000fffff, 0x000000c0),
    EMIT_MASKWRITE(0xf8006190, 0x6ffffefe, 0x00040080),
    EMIT_MASKWRITE(0xf8006194, 0x000fffff, 0x0001fc82),
...
unsigned long ps7_mio_init_data_3_0[] = {
    ...
    EMIT_MASKWRITE(0xf8000b5c, 0xffffffff, 0x0018c61c),
    EMIT_MASKWRITE(0xf8000b60, 0xffffffff, 0x00f9861c),
    EMIT_MASKWRITE(0xf8000b64, 0xffffffff, 0x00f9861c),
    EMIT_MASKWRITE(0xf8000b68, 0xffffffff, 0x00f9861c),
    EMIT_MASKWRITE(0xf8000b6c, 0x00007fff, 0x00000260),
    ...
    EMIT_MASKWRITE(0xf8000700, 0x00003fff, 0x00001610),
    EMIT_MASKWRITE(0xf8000704, 0x00003fff, 0x00001700),
    EMIT_MASKWRITE(0xf8000708, 0x00003fff, 0x00000710),
    EMIT_MASKWRITE(0xf800070c, 0x00003fff, 0x00000710),
    EMIT_MASKWRITE(0xf8000710, 0x00003fff, 0x00000710),
    EMIT_MASKWRITE(0xf8000714, 0x00003fff, 0x00000710),
    EMIT_MASKWRITE(0xf8000718, 0x00003fff, 0x00000710),
    ...
    EMIT_MASKWRITE(0xf8000738, 0x00003fff, 0x00001611),
    EMIT_MASKWRITE(0xf800073c, 0x00003fff, 0x00001600),
    EMIT_MASKWRITE(0xf8000740, 0x00003fff, 0x00001302),
    EMIT_MASKWRITE(0xf8000744, 0x00003fff, 0x00001302),
    EMIT_MASKWRITE(0xf8000748, 0x00003fff, 0x00001302),
    EMIT_MASKWRITE(0xf800074c, 0x00003fff, 0x00001302),
    EMIT_MASKWRITE(0xf8000750, 0x00003fff, 0x00001302),
    EMIT_MASKWRITE(0xf8000754, 0x00003fff, 0x00001302),
    EMIT_MASKWRITE(0xf8000758, 0x00003fff, 0x00001303),
    EMIT_MASKWRITE(0xf800075c, 0x00003fff, 0x00001303),
    EMIT_MASKWRITE(0xf8000760, 0x00003fff, 0x00001303),
    EMIT_MASKWRITE(0xf8000764, 0x00003fff, 0x00001303),
    EMIT_MASKWRITE(0xf8000768, 0x00003fff, 0x00001303),
    EMIT_MASKWRITE(0xf800076c, 0x00003fff, 0x00001303),
    EMIT_MASKWRITE(0xf8000770, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf8000774, 0x00003fff, 0x00001305),
    EMIT_MASKWRITE(0xf8000778, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf800077c, 0x00003fff, 0x00001305),
    EMIT_MASKWRITE(0xf8000780, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf8000784, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf8000788, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf800078c, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf8000790, 0x00003fff, 0x00001305),
    EMIT_MASKWRITE(0xf8000794, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf8000798, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf800079c, 0x00003fff, 0x00001304),
    EMIT_MASKWRITE(0xf80007a0, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007a4, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007a8, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007ac, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007b0, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007b4, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007b8, 0x00003fff, 0x00001200),
    EMIT_MASKWRITE(0xf80007bc, 0x00003f01, 0x00001301),
    EMIT_MASKWRITE(0xf80007c0, 0x00003fff, 0x000012e0),
    EMIT_MASKWRITE(0xf80007c4, 0x00003fff, 0x000012e1),
    EMIT_MASKWRITE(0xf80007c8, 0x00003fff, 0x00001200),
    EMIT_MASKWRITE(0xf80007cc, 0x00003fff, 0x00001200),
    EMIT_MASKWRITE(0xf80007d0, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf80007d4, 0x00003fff, 0x00001380),
    EMIT_MASKWRITE(0xf8000830, 0x003f003f, 0x002f0037),
    EMIT_WRITE(0xf8000004, 0x0000767b),
    EMIT_EXIT(),
};
...
unsigned long ps7_peripherals_init_data_3_0[] = {
    ...
    EMIT_MASKWRITE(0xe0001018, 0x0000ffff, 0x0000007c),
    ...
    EMIT_WRITE(0xe000e014, 0x00229133),
    EMIT_MASKWRITE(0xe000e018, 0x00000003, 0x00000000),
    EMIT_WRITE(0xe000e010, 0x02400000),
    EMIT_MASKWRITE(0xe000a244, 0x003fffff, 0x00004000),
    EMIT_MASKWRITE(0xe000a008, 0xffffffff, 0xbfff4000),
    EMIT_MASKWRITE(0xe000a248, 0x003fffff, 0x00004000),
    EMIT_MASKWRITE(0xe000a008, 0xffffffff, 0xbfff0000),
...
unsigned long ps7_debug_3_0[] = {
    EMIT_WRITE(0xf8898fb0, 0xc5acce55),
    EMIT_WRITE(0xf8899fb0, 0xc5acce55),
    EMIT_WRITE(0xf8809fb0, 0xc5acce55),
    EMIT_EXIT(),
};
...
unsigned long ps7_ddr_init_data_2_0[] = {
    ...
    EMIT_MASKWRITE(0xf8006018, 0xf7ffffff, 0x44e458d2),
    EMIT_MASKWRITE(0xf800601c, 0xffffffff, 0x720238e5),
    EMIT_MASKWRITE(0xf8006020, 0xfffffffc, 0x272872d0),
...
unsigned long ps7_mio_init_data_1_0[] = {
    ...
    EMIT_MASKWRITE(0xf8000b64, 0xffffffff, 0x00f9861c),
    EMIT_MASKWRITE(0xf8000b68, 0xffffffff, 0x00f9861c),
    EMIT_MASKWRITE(0xf8000b6c, 0x000073ff, 0x00000260),
    EMIT_MASKWRITE(0xf8000b70, 0x00000021, 0x00000021),
    EMIT_MASKWRITE(0xf8000b70, 0x00000021, 0x00000020),
    EMIT_MASKWRITE(0xf8000b70, 0x07ffffff, 0x00000823),
    EMIT_MASKWRITE(0xf8000700, 0x00003fff, 0x00001610),
